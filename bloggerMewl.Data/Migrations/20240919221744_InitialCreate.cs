        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedByName = table.Column<string>(type: "varchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<byte[]>(type: "binary(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoAuthor = table.Column<string>(type: "varchar(max)", nullable: false),
                    SeoDescription = table.Column<string>(type: "varchar(max)", nullable: false),
                    SeoTags = table.Column<string>(type: "varchar(max)", nullable: false),
                    ViewsCount = table.Column<int>(type: "int", nullable: false),
                    Thumbnail = table.Column<string>(type: "varchar(max)", nullable: false),
                    CreatedByName = table.Column<string>(type: "varchar(max)", nullable: false),
                    ModifiedByName = table.Column<string>(type: "varchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
